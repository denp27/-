...
from app.handlers import (
    ...
    franchise_router, checks_router, history_router, gifts_router
)
from app.pyrogram_client import setup_pyrogram
from app.middleware import BanMiddleware, CallbackAnswerMiddleware, RateLimitMiddleware
    ...
    for gift in all_gifts:
        ...
        if existing_address:
            ...
            try:
                ...
                log.warning("Ошибка получения адреса коллекции %s: %s", gift, e)
                continue
