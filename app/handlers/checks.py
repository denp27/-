...
from app.helpers import exit_button, effective_markup, calc_star_sell_price, send_admin_notification
from app.states import CheckState
from app.config import COMMISSION_PREMIUM, COMMISSION_TON
...
async def activate_check(message: Message, bot: Bot, check_id: str, franchise_id: int = 0):
    ...
    async def do_activation():
        ...
        return success and check_type == 'stars'
